...
def main():
    ...
    def processing():
        ...
        # specify the location of the chat.csv file below
        # copy the cloned repository path and at the end add "\\chat.csv"
        uploaded_file='C:\\Users\\Kavin\\Desktop\\desi_rail_chatbot\\chat.csv' 
    ...
    def initialize(x,y):
        ...
        with st.form(key='my_form'):
            ...
            df1[['Train No', 'Train Name', 'Sequences','Station Name', 'Next Station','Arrival time', 'Departure Time', 'Distance1']].to_csv('chat.csv',encoding='utf-8')
